...
import { getDirectores, crearDirector, actualizarDirector } from '../../services/directorService';
...
export const DirectorView = () => {
  ...
  const [directorSeleccionado, setDirectoresSeleccionado] = useState(null);
  ...
  const handleCrearDirector = async (e) => {
    ...
    try {
      ...
      if (directorSeleccionado){
        ...
        setDirectoresSeleccionado(null);
      }
      else{
  ...
  const handleActualizarDirector = async (e,director) =>{
    ...
    setDirectoresSeleccionado(director._id);
  };
